...
public class JavaCameraView extends CameraBridgeViewBase implements PreviewCallback {
    ...
    static Camera.Parameters  params, params1;
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (sizes != null) {
                    ...
                    if (FlashMode != null && FlashMode.contains(Camera.Parameters.FLASH_MODE_TORCH))// && flash==0)
                        {
    ...
    public static void turnOnFlash(){
        List<String> FlashMode = params1.getSupportedFlashModes();
    ...
    public static void turnOffFlash(){
        ...
        if (FlashMode != null && FlashMode.contains(Camera.Parameters.FLASH_MODE_TORCH) )
        {
            params1.setFlashMode(Camera.Parameters.FLASH_MODE_OFF);
            mCamera.setParameters(params1);
        }
    }
}
